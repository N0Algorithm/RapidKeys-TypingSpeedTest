...
export const Results = ({ stats, duration, restart, sessionKeys, wpmHistory = [], typedWords = [], playSound }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-start w-full max-w-3xl mx-auto py-5 sm:py-6 px-3 sm:px-4">
            ...
            <div className="flex flex-col items-center mb-4 text-center">
                ...
                <span className="text-5xl sm:text-6xl font-bold text-[var(--color-caret)] leading-none">
                    {calculations.wpm}
                </span>
                ...
                <div className="flex items-baseline gap-2 mt-1">
                    ...
                    <span className="text-xl sm:text-2xl font-semibold text-text-primary opacity-70">{calculations.raw}</span>
                </div>
            </div>
            ...
            ═══════════════════════════════════════════════════════════ */}
            <div className="grid grid-cols-3 gap-4 sm:gap-6 mb-4 w-full max-w-lg">
                <div className="text-center">
                    <div className="text-[9px] uppercase tracking-widest text-text-secondary opacity-40">acc</div>
                    <div className="text-base sm:text-lg text-text-primary font-medium">{calculations.acc}%</div>
                </div>
                <div className="text-center">
                    <div className="text-[9px] uppercase tracking-widest text-text-secondary opacity-40">consistency</div>
                    <div className="text-base sm:text-lg text-text-primary font-medium">{calculations.consistency}%</div>
                </div>
                <div className="text-center">
            ...
            ═══════════════════════════════════════════════════════════ */}
            {wpmHistory.length > 1 && (
                <div className="w-full max-w-md mb-5 opacity-70 px-1">
